...
<title>Hacked by X-VDP-X - HXH-ARMENIEN</title>
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  @keyframes pulseNeon {
    0%,100% { box-shadow: 0 0 10px #00bfff,0 0 20px #00bfff; }
    50% { box-shadow: 0 0 20px #00d4ff,0 0 40px #00d4ff,0 0 60px #00d4ff; }
  }
...
<div class="content">
  <div class="logo-container" onclick="window.location.href='https://t.me/xvdpx'">
    ...
    <img src="https://i.ibb.co/SDvRZ3X5/HXH-ARMENIEN.png" alt="Logo HXH-ARMENIEN" />
  </div>

  <h1 id="typewriter"></h1>
  <h2># Hack Word # Hacked # X-VDP-X # HXH-ARMENIEN</h2>
  <h3>
  ...
  <button class="btn" onclick="window.location.href='https://t.me/xvdpx'">TELEGRAM</button>
</div>
...
resize();
window.addEventListener('resize', () => { resize(); drops = Array(columns).fill(1); });
...
const text = "Hacked by X-VDP-X - HXH";
