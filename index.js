...
<head>
  ...
  <title>Deface X-VDP-X - HXH ARMENIEN</title>
  <style>
...
<body>
  <h1>X-VDP-X<br>HXH ARMENIEN</h1>
  
  <div class="logos">
    <a href="https://t.me/xvdpx" target="_blank" rel="noopener noreferrer" aria-label="telegram">
      <img src="https://i.postimg.cc/q79gXyTp/image-2.webp" alt="VDP" />
    </a>
    <a href="https://t.me/xvdpx" target="_blank" rel="noopener noreferrer" aria-label="telegram">
      <img src="https://i.ibb.co/SDvRZ3X5/HXH-ARMENIEN.png" alt="HXH" />
    </a>
  </div>
  
  <p class="typewriter" id="typewriter"></p>
  
  <a href="https://t.me/xvdpx" target="_blank" class="btn-telegram" rel="noopener noreferrer" aria-label="Lien Telegram X-VDP-X">Telegram</a>

<script>
  const messages = [
    "Hacked by X-VDP-X — HXH — Nous sommes partout.",
    "VOTRE PEUR NOUS ALIMENTE, VOTRE SYSTÈME NOUS APPARTIENT.",
    "Nous sommes partout nous voyons tout et entendons tout",
    "X-VDP-X - HXH",
  ];
  ...
  function type() {
    ...
    setTimeout(type, isDeleting ? 140 : 280);
  }
